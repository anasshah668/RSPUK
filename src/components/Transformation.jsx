        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-start gap-3 mb-4">
              <span 
                className={`text-xs font-semibold transition-colors ${!isNeon ? 'text-gray-900' : 'text-gray-400'}`}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-600 leading-7 text-base" style={{ fontFamily: 'Lexend Deca, sans-serif' }}>
              <p>
                From standard signage to glowing neon — see the difference our craftsmanship makes. Toggle the switch to experience how your brand can stand out with our premium neon solutions.
              </p>
              <p>
