...
const Services = () => {
  const services = [
    {
      title: 'Sign & Neon Signs',
      description: 'Indoor and outdoor signage, including custom neon signs, crafted for maximum brand visibility.',
      icon: (
    ...
    {
      title: 'Printing',
      description: 'High-quality print services for flyers, posters, banners, and marketing materials.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Frosted, vinyl, and full-colour window graphics tailored to your business.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Fabrication',
      description: 'Bespoke fabrication including 3D letters, metalwork, and custom builds.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="services" className="py-20" style={{ backgroundColor: '#333333' }}>
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
        <div className="text-center mb-16">
          ...
          >
            From concept to installation — everything your brand needs to stand out.
          </p>
        </div>
